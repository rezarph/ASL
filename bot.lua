...
`فقط کافیست یوزرنیم ربات یعنی @ASL_Bede_Bot تایپ کنید و بعد از آن یک فاصله اضافه کنید و منتظر بمانید تا کلیدهای ربات ظاهر شود. با انتخاب هر کلید میتوانید از آن استفاده کنید. همانطور که گفته شد از این قابلیت میتوانید در چت های خصوصی، گروه ها و حتی کانال بهره ببرید.`
]]
...
روش استفاده از قابلیت اینلاین:
`فقط کافیست یوزرنیم ربات یعنی @ASL_Bede_Botرا تایپ کنید و بعد از آن یک فاصله اضافه کنید و منتظر بمانید تا کلیدهای ربات ظاهر شود. با انتخاب هر کلید میتوانید از آن استفاده کنید. همانطور که گفته شد از این قابلیت میتوانید در چت های خصوصی، گروه ها و حتی کانال بهره ببرید.`
]]
...
{
{text = "RoBoT" , url = 'https://telegram.me/ASL_ede_Bot'}
}
}
